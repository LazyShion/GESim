...
def graph_entropy_similarity(
    ...
    Args:
        ...
        r (int, optional): Radius parameter of fingerprint calculation.
                           Defaults to 4.
        uncertainty (int, optional): [WIP] Uncertainty parameter. If the parameter is set to -1, use graph_entropy_best().
                                     Defaults to -1.
    ...
    if uncertainty == -1:
        ge_calculator = graph_entropy.GraphEntropy(db, r, 0)
        ge_value = ge_calculator.graph_entropy_best(0, 1)
    else:
        ge_calculator = graph_entropy.GraphEntropy(db, r, uncertainty)
...
def graph_entropy_similarity_batch(
    ...
    if uncertainty == -1:
        ge_calculator = graph_entropy.GraphEntropy(db, r, 0)
        ge_values = ge_calculator.graph_entropy_all_best(0)
    else:
        ge_calculator = graph_entropy.GraphEntropy(db, r, uncertainty)
